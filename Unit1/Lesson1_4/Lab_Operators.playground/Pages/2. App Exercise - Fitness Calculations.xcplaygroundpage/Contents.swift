...
print("The average heart rate using Double is \(averageHRD).")
// The result may include a fractional value due to Double precision, whereas the previous result was an integer because of integer division.
...
print("The user has achieved \(percentOfGoal)% of their step goal.")
