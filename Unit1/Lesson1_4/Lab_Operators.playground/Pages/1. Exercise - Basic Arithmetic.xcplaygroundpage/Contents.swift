...
print("The area of the yard is \(area) square units.")
...
*/
let roomArea = area / 2
print("Each room will have an area of \(roomArea) square units.")
...
print("The perimeter of the yard is \(perimeter) units.")
...
print("The result of 10 divided by 3 using integer division is \(integerDivisionResult).")
...
print("The result of 10 divided by 3 using floating-point division is \(divisionResult).")
...
let even = 6
let odd = 7
print("The remainder when \(even) is divided by 2 is \(even % 2).")
print("The remainder when \(odd) is divided by 2 is \(odd % 2).")
