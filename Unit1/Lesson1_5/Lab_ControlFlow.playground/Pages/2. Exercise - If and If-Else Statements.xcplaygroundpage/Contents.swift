...
// If statement to check if dollars is 0
if dollars == 0 {
    print("Sorry, kid. You're broke!") // Expected: "Sorry, kid. You're broke!"
}

/*:
`dollars` has been updated below to have a value of 10. Write an if-else statement that prints "Sorry, kid. You're broke!" if `dollars` has a value of 0, but prints "You've got some spending money!" otherwise. Observe what is printed to the console.
*/
dollars = 10

// If-else statement to check if dollars is 0 or not
if dollars == 0 {
    print("Sorry, kid. You're broke!") // Expected: "Sorry, kid. You're broke!"
} else {
    print("You've got some spending money!") // Expected: "You've got some spending money!"
}
...
// If-else-if statement to check different ranges of dollar amounts
if dollars == 0 {
    print("Sorry, kid. You're broke!") // Expected: "Sorry, kid. You're broke!"
} else if dollars < 100 {
    print("You've got some spending money!") // Expected: "You've got some spending money!"
} else {
    print("Looks to me like you're rich!") // Expected: "Looks to me like you're rich!"
}
