 ...
 */
var steps = 4500 // Example value
let stepGoal = 10000

if steps < stepGoal / 2 {
    print("You're almost halfway there!") // Expected if steps < 5000
} else {
    print("You're over halfway there!") // Expected if steps >= 5000
}
...
if steps < stepGoal / 10 {
    print("Way to get a good start today!") // Expected if steps < 1000
} else if steps < stepGoal / 2 {
    print("You're almost halfway there!") // Expected if steps between 1000 and 4999
} else {
    print("You're over halfway there!") // Expected if steps >= 5000
}
