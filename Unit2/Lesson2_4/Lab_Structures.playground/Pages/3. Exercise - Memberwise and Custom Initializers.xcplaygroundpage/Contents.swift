...
let favoriteBook = Book(title: "The Hobbit", author: "J.R.R. Tolkien", pages: 310, price: 15.99)
...
print("Laptop 1: Screen Size \(laptop1.screenSize), Repairs \(laptop1.repairCount), Year Purchased \(laptop1.yearPurchased)")
print("Laptop 2: Screen Size \(laptop2.screenSize), Repairs \(laptop2.repairCount), Year Purchased \(laptop2.yearPurchased)")
/*:
...
print("My height is \(myHeight.heightInInches) inches or \(myHeight.heightInCentimeters) cm.")
/*:
