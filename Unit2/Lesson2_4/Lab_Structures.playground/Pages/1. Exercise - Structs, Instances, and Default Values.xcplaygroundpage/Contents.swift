...
print("Updated Laritude: \(somePlace.latitude), Updated Longitude: \(somePlace.longitude)")
...
favoriteBook.title = "Pride and Prejudice"
favoriteBook.author = "Jane Austen"
favoriteBook.pages = 432
favoriteBook.price = 9.99

print("Favorite Book Details:")
