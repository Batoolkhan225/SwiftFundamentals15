...
struct User {
    ...
    static var currentUser: User = User(userName: "Batool Khan", email: "Batoolkhan225@gail.com", age: 23)
 ...
 */
let newUser = User(userName: "Alice", email: "alice@example.com", age: 30)

User.logIn(user: newUser)

print("New Current User: \(User.currentUser.userName), Email: \(User.currentUser.email), Age: \(User.currentUser.age)")
/*:
