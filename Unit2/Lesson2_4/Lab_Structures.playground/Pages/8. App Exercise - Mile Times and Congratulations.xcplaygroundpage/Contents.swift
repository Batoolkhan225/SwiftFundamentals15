...
let myRun = RunningWorkout(distance: 3200, time: 20, elevation: 50)
print("Average mile time: \(myRun.averageMileTime) minutes per mile")
/*:
...
print("Current steps: \(mySteps.steps)")
mySteps.takeStep()
/*:
