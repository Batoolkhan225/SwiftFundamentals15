...
print("Initial: \(myHeight.heightInInches) inches, \(myHeight.heightInCentimeters) cm")

myHeight.heightInInches = 70
print("Updated: \(myHeight.heightInInches) inches, \(myHeight.heightInCentimeters) cm")
