...
let runningChallenges: [String] = ["Run 5 times a week", "Complete a 5K run"]

let calisthenicsChallenges: [String] = ["Do 50 push-ups daily", "Hold a 2-minute plank"]
let weightliftingChallenges: [String] = ["Lift weights 3 times a week", "Increase bench press by 10 lbs"]
...
var committedChallenges: [String] = [] // Can be empty or have some challenges
// Example: Uncomment the next line to simulate a committed challenge
// committedChallenges.append("Run 5 times a week")
